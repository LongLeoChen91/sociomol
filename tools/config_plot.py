...
P_THRESHOLD_MAP = 0.03        # Applied to the 2D energy landscape overlay
P_THRESHOLD_DIST = 0.03       # Applied to the 1D length distribution histogram
...
CONTOUR_THRESHOLDS = [0.03, 0.01]

# --- Plotting Visuals : 1D Length Distribution ---
FIT_MODE = "gmm"          # "single" for normal Gaussian, "gmm" for Gaussian Mixture
