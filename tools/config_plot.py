...
P_THRESHOLD_MAP = 0.01        # Applied to the 2D energy landscape overlay
P_THRESHOLD_DIST = 0.01       # Applied to the 1D length distribution histogram

# --- Energy Model Physics Constants (For 2D Energy Landscape) ---
LP = 50                     # (nm) Persistence length (e.g., 1.5 for mRNA, 50 for DNA)
L0 = 10                    # (nm) Reference length (ideally connection length)
...
CONTOUR_THRESHOLDS = [0.0001, 0.04]
