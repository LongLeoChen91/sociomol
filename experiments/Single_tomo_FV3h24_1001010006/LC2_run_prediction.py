...
# ---------- User params ----------
INPUT_STAR  = "subset_H1_DoubleLinker_T1001010006.star"
...
DIST_CUTOFF_NM = 30 # [nm] Arm–arm distance cutoff; (i,j) kept if min(|ai-aj|) < cutoff
LP_NM = 50.0     # persistence length
L0_NM = 25       # reference length
P_THRESHOLD = 0.1
...
if __name__ == "__main__":
    ...
    assigner = LinkerAssigner(
        ...
        toward_cos_threshold=0.0         # angle with line < 90°; can change to 0.5≈60° stricter; (1=0°,0=90°,-1=180°)
    )
