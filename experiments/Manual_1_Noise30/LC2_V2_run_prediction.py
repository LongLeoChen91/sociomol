...
THETA0_DEG = 45.0                   # 45； [deg] Reference angle for angle penalty
...
MAX_HALF_BENDING_DEG = 90.0          # 5； Angle with line threshold (0.0 for <90°)
