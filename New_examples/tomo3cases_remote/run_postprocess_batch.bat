...
cd /d "%~dp0\..\.."
echo === Running SocioMol Post-processing (per-tomo) for tomo3cases_remote ===

set BASE=New_examples/tomo3cases_remote
set RAW_STAR=%BASE%/prepared_run_data_3tomos_job006.star
set ANNOTATED_STAR=%BASE%/prepared_run_data_3tomos_job006_arms_annotated.star
